...
import { getPopularShows, getTopRatedShows, getOnTheAirShows } from '../services/tmdb'
import MediaGrid from '../components/MediaGrid'

const tabs = [
  { id: 'popular', label: 'Popular', fetch: getPopularShows },
  { id: 'top_rated', label: 'Top Rated', fetch: getTopRatedShows },
  { id: 'on_the_air', label: 'On The Air', fetch: getOnTheAirShows },
]
...
export default function ShowsPage() {
  ...
  return (
    <div className="min-h-screen pt-20 pb-24 md:pb-8 px-4 sm:px-6 max-w-7xl mx-auto">
      ...
      <MediaGrid items={data?.results} type="tv" loading={loading} />
